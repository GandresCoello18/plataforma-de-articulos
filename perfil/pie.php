       ...
       <div class="row pie">
            <div class="col-12 col-md-6 justify-content-center d-flex">
              ...
              <ul>
                ...
                <li><a href="../sobre_nosotros.php" id="sobre_nosotros">Sobre Nosotros</a></li>
              </ul>
             </div>
...
$("#cerrar").click(function(){
   $("#navegacion-cell").toggle("fast");  
   document.getElementById("submenu_cell").style.display = "none";
})
  ...
  software_lista.addEventListener("click", lista);
    function lista(){
