...
<div class="row perfil">
	 <div class="col-12 col-md-6 justify-content-center p-4">
	    ...
	    <h3 class="text-center profecion">Desarrollo de Software</h3>
      <hr style="height: 1px; background-color: #cdcdcd;"/>
	 ...
	 <div class="col-12 col-md-6 justify-content-center p-4">
	 	...
	 	<hr style="height: 1px; background-color: #cdcdcd;"/>
	 	<p class="text-center">Instituto</p>
	 </div>
...
<section class="container mt-md-3 mt-5 texto">
	 <div class="row">
	 	  <div class="col sobre_mi p-3">
	 	  	   <p><span>S</span>oy un joven adolecente con ganas de adquirir conocimientos intelectuales desempañados en el área del desarrollo de sistemas e informáticas. He alcanzado tener algunas habilidades en estas profesiones y me gustaría que muchas personas también se beneficien de aquello así como lo sigo haciendo yo. Algo que me ayuda muchísimo a mí, son los artículos e informaciones que encuentras en internet prácticamente se encuentra un sin número de cosas y sobre cualquier cosa, la mayoría de las personas poseemos esta gran herramienta pero <strong>¿Sabes Utilizarla?</strong> En mi opinión 'internet' es la mejor fuente de información, conocimiento, y sobre todo la mejor ayuda para los estudios.</p>
	 	  	   <p> Es por eso que este sitio fue desarrollado con el fin de beneficiarnos todos, publicando artículos que te pueden interesar o que puedes aprender algo nuevo. Si te interesa algún Tema pero no está disponible en el sitio puedes contactarte conmigo mediante un <a href="#" data-toggle="modal" data-target="#myModal">Mensaje hacer click</a> para publicarlo incluido tu nombre y apellido para que la comunidad lo vea. O tambien <a href="iniciar sesion.php">crea una cuenta</a> para aumentar la probabilidad de la publicacion de articulo.</p>
	 	  </div>
	 </div>
</section>
